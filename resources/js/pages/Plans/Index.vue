...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        >
    <div class="mt-3">
            <Link href="/planes/create" :class="buttonVariants({variant:'outline'})">Agregar Plan </Link>
        </div>

            <div class="div p-6 text-gray-900">
                <DataTable :data="plans" :columns="columns" class="display w-full" :options="{ responsive: true }">
                    <thead>
                        <tr>
                            <th>Nombre</th>
                            <th>Descripción</th>
